    ...
    <>
      ...
      <div className="w-full max-w-[1200px] mx-auto py-8">
        ...
        >
          {/* Slide 1 */}
          <SwiperSlide>
            <div className="relative flex items-center justify-start h-[400px] overflow-hidden rounded-[10px] shadow-md opacity-80">
              <img
                src="/images/image-slide-1.jpeg"
                alt="Slide 1"
                className="w-full h-full object-cover brightness-[70%] transition-transform duration-300 ease-in-out hover:scale-105"
              />

              <div className="slide-content">
                <h1 className="text-4xl my-2 mb-4 text-white font-sans">
                  File sharing &
                </h1>
